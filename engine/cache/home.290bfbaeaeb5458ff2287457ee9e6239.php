...
<head>
	...
	<link rel="stylesheet" type="text/less" media="screen" href="sources/templates/default/modules/home/../../css/default.css" />
	<script type="text/javascript" src="sources/templates/default/modules/home/../../js/less.min.js"></script>
		...
		<ul class="menu" id="black">
			...
			<li><a href="#" class="drop">Home</a>
				...
				<div class="dropdown_2columns">
					<div class="col_2">
						<h2><?php echo $name;?> <img src="sources/templates/default/modules/home/img/logout.png" class="img_right"  alt="Logout"/> </h2>
					</div>
					...
					<div class="col_1 firstcolumn">
						<img src="sources/templates/default/modules/home/img/donate.png" width="125" height="48" alt="" />
					</div>
				...
				<div class="dropdown_5columns">
					...
					<div class="col_5 firstcolumn">
						...
						<div class="col_3 firstcolumn">
							<img src="sources/templates/default/modules/home/img/01.jpg" width="70" height="70" class="img_left imgshadow_light" alt="" />
							...
							<img src="sources/templates/default/modules/home/img/02.jpg" width="70" height="70" class="img_left imgshadow_light" alt="" />
			...
			<li class="right"><a href="#" class="drop">Contact</a>
				<div class="dropdown_2columns align_right">
					...
					<div class="col_2 firstcolumn">
						<h2>Keep in touch</h2>
						<ul class="social">
							<li><a href="#"><img src="sources/templates/default/modules/home/img/twitter.png" alt="" /><span>Twitter</span></a></li>
							<li><a href="#"><img src="sources/templates/default/modules/home/img/facebook.png" alt="" /><span>Facebook</span></a></li>
						</ul>
					</div>
				</div>
			</li>
	...
	<div class="container_12" id="mainbox">
		...
		<aside class="grid_4">
			...
			<div id="useful">
				...
				<br /><br />
				<img src="sources/templates/default/modules/home/../../img/donate.png" />
			</div>

			<div id="msg">
				<a href="#">14</a> unread messages
			</div>
