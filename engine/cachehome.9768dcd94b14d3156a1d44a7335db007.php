...
<head>
	...
	<link rel="stylesheet" type="text/css" media="screen" href="engine/templates/default/sources/themes/default.css" />
...
<body>
		...
		<ul class="menu" id="black">
			...
			<li><a href="#" class="drop">Home</a>
				...
				<div class="dropdown_2columns">
					<div class="col_2">
						<h2><?php echo $name;?> <img src="engine/templates/default/img/logout.png" class="img_right"  alt="Logout"/> </h2>
					</div>
					...
					<div class="col_1 firstcolumn">
						<img src="engine/templates/default/img/donate.png" width="125" height="48" alt="" />
					</div>
				...
				<div class="dropdown_5columns">
					...
					<div class="col_5 firstcolumn">
						...
						<div class="col_3 firstcolumn">
							<img src="engine/templates/default/img/01.jpg" width="70" height="70" class="img_left imgshadow_light" alt="" />
							...
							<img src="engine/templates/default/img/02.jpg" width="70" height="70" class="img_left imgshadow_light" alt="" />
			...
			<li class="right"><a href="#" class="drop">Contact</a>
				<div class="dropdown_2columns align_right">
					...
					<div class="col_2 firstcolumn">
						<h2>Keep in touch</h2>
						<ul class="social">
							<li><a href="#"><img src="engine/templates/default/img/twitter.png" alt="" /><span>Twitter</span></a></li>
							<li><a href="#"><img src="engine/templates/default/img/facebook.png" alt="" /><span>Facebook</span></a></li>
						</ul>
					</div>
				</div>
			</li>
	...
	<div class="container_12" id="mainbox">
		<div class="message" id="tip">
			<p>Login to access missions and content.</p>
		</div>
	</div>
	<!--/Content -->
</body>
