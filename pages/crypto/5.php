...
<div class="newsbox">
<div align="center">
<div class="name">RAR Recovery</div></div>
...
<center>
<p><a href="extension/downloads/c5.rar" target="_blank">Click here to download the password protected archive.</a><br />
<form method="post">
<p>Password</p><br />
...
if (isset($_POST["submit"])) {
  if ($_POST["code"] == 'fal40faa') {

$query =  mysql_query("UPDATE hxm_members SET c5 = '1' WHERE member_id = '$memid'");
