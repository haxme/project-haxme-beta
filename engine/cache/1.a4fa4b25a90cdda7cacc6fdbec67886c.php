...
<head>
	<meta charset=utf-8 />
	<title>HaxMe - [Index->Missions]</title>
	<link rel="stylesheet" type="text/less" media="screen" href="sources/templates/default/modules/missions/beginner/../../../css/default.css" />
	<script type="text/javascript" src="sources/templates/default/modules/missions/beginner/../../../js/less.min.js"></script>
...
<body>
		...
		<ul class="menu" id="black">
			...
			<li><a href="#" class="drop">Home</a>
				...
				<div class="dropdown_2columns">
					<div class="col_2">
						<h2>cwade12c <img src="sources/templates/default/modules/missions/beginner/img/logout.png" class="img_right"  alt="Logout"/> </h2>
					</div>
					...
					<div class="col_1 firstcolumn">
						<img src="sources/templates/default/modules/missions/beginner/img/donate.png" width="125" height="48" alt="" />
					</div>
				...
				<div class="dropdown_5columns">
					...
					<div class="col_5 firstcolumn">
						...
						<div class="col_3 firstcolumn">
							<img src="sources/templates/default/modules/missions/beginner/img/01.jpg" width="70" height="70" class="img_left imgshadow_light" alt="" />
							...
							<img src="sources/templates/default/modules/missions/beginner/img/02.jpg" width="70" height="70" class="img_left imgshadow_light" alt="" />
			...
			<li class="right"><a href="#" class="drop">Contact</a>
				<div class="dropdown_2columns align_right">
					...
					<div class="col_2 firstcolumn">
						<h2>Keep in touch</h2>
						<ul class="social">
							<li><a href="#"><img src="sources/templates/default/modules/missions/beginner/img/twitter.png" alt="" /><span>Twitter</span></a></li>
							<li><a href="#"><img src="sources/templates/default/modules/missions/beginner/img/facebook.png" alt="" /><span>Facebook</span></a></li>
						</ul>
					</div>
				</div>
			</li>
	...
	<div class="container_12" id="mainbox">
		<div class="grid_2">
			<p id="title">&raquo; PlainSRC Password</p>
		</div>	
		<div class="grid_10">
			<div id="mission_info">
				<p>&raquo; Beginner Missions are targeted for novice programmers/hackers alike.
				<br />
				&raquo; We urge you to try and complete these missions in a browser with 0 plugins. It will improve your knowledge immensely.
				<br />
				&raquo; Each mission contains resources to help you get started. Take advantage of them!
				</p>
			</div>
		</div>
		...
		<div class="grid_4 alpha">
			<div id="resource_info">
				<p>This mission requires a basic understanding of HTML. HTML stands for <i>Hyper Text Markup Language</i>, a language that websites use to communicate with your browser.</p>
			</div>
		
			<div id="resource_list">
				<h3>Resources</h3>
				<p><a href="http://www.w3schools.com/html/html_intro.asp" target="_blank" id="link">Getting started - W3Schools</a></p>
				<p><a href="http://www.tizag.com/htmlT/" target="_blank" id="link">Continuing your learning - Tizag</a></p>
				<p><a href="http://net.tutsplus.com/tutorials/html-css-techniques/30-html-best-practices-for-beginners/" target="_blank" id="link">Good practices - NET.Tuts+</a></p>
				<p><a href="http://html5sec.org/" target="_blank" id="link">Awareness - HTML5 Security</a></p>
				<p><a href="http://diveintohtml5.org/" target="_blank" id="link">Serious - Dive Into HTML5</a></p>
				<hr />
		...
		<div class="grid_8 omega" id="mission">
			<h2>Beginner 1 - PlainSRC Password</h2>
			<form method="post">
