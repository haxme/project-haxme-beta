...
<center>
<p><a href="http://www.mediafire.com/?ml5o21iyewy" target="_blank">Click here to download the encrypted file.</a></p><br />
<form method="post">
<p>Password</p><br />
...
if (isset($_POST["submit"])) {
  if ($_POST["code"] == 'c10-dka381918*') {

$query =  mysql_query("UPDATE hxm_members SET c10 = '1' WHERE member_id = '$memid'");
