<?php if(!class_exists('raintpl')){exit;}?>	<!-- Navigation System -->
	<nav id="wrapper_menu">
		<ul class="menu" id="black">
			...
			<li><a href="#" class="drop">Home</a>
				...
				<div class="dropdown_2columns">
					<div class="col_2">
						<h2><?php echo $name;?> <img src="sources/templates/default/modules/missions/beginner/../../../img/logout.png" class="img_right"  alt="Logout"/> </h2>
					</div>
