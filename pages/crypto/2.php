...
<div class="newsbox">
<div align="center">
<div class="name">Textbook</div></div>
...
<center>
<p><a href="extension/downloads/c2.txt" target="_blank">Click here to view encrypted email.</a><br />
<form method="post">
<p>Password</p><br />
...
if (isset($_POST["submit"])) {
  if ($_POST["code"] == 'rot13lol') {

$query =  mysql_query("UPDATE hxm_members SET c2 = '1' WHERE member_id = '$memid'");
